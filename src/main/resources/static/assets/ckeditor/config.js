...
//config.filebrowserImageUploadUrl = '/images/ckeditorUpload?command=QuickUpload&type=Images';
    ...
    config.uploadUrl = '/admin/ckeditorUpload';
    config.filebrowserUploadUrl = '/admin/ckeditorUpload?command=QuickUpload&type=Files';
    config.filebrowserImageUploadUrl = '/admin/ckeditorUpload?command=QuickUpload&type=Images';
